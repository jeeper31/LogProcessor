...
public class MapperReducer_UT {
    ...
    public void setUp() {
        ...
        ExceptionReducer reducer = new ExceptionReducer();
    ...
    public void testMapper() {
        ...
        mapDriver.withOutput(new Text("RegionResource.java:282"), new DoubleWritable(1));
        mapDriver.runTest();
    }
    ...
    public void testMapReduce() {
        ...
        mapReduceDriver.withOutput(new Text("RegionResource.java:282"), new DoubleWritable(1));
